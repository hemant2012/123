...
namespace Microsoft.Crm.Sdk.Samples
{
    ...
    public class ServerConnection
    {
        ...
        public virtual Array GetOrganizations(String u_name, String P_word)
        {
           ...
           ReadConfigurations();
            ...
            Array.Copy(GetOrgList(u_name, P_word),a,50);
            
            
            return a;
        }

        public Array GetOrgList(String u_name, String P_word)
        {
